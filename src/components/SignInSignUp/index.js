...
export default class SignInSignUp extends Component {
  ...
  render() {
    ...
    const loginClass = isRegister ? 'active' : 'inactive';
    const registerClass = isRegister ? 'inactive' : 'active';
    const linkUrl = isRegister ? '/register' : '/login';
    const buttonName = isRegister ? '登录' : '注册';
